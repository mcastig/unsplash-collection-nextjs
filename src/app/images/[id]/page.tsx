...
export default function ImageDetailPage() {
  ...
  const { currentImage, imageCollections, loading } = useAppSelector(
    (s) => s.image,
  );
              ...
              {imageCollections.map((ic) => (
                <li key={ic.collectionId} className={styles.collectionItem}>
                  {ic.entry.image_thumb_url ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img
                      className={styles.colThumb}
                      src={ic.entry.image_thumb_url}
                      alt=""
                    />
                  ) : (
                  ...
                  <div className={styles.colInfo}>
                    ...
                    <p className={styles.colCount}>
                      {collections.find((c) => c.id === ic.collectionId)
                        ?.image_count ?? 0}{" "}
                      photos
                    </p>
                  </div>
